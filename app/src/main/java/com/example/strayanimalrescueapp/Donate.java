...
public class Donate extends AppCompatActivity {
    public static final String clientKey = "ASpTYOzSqoDMsbr6Zc2BQYAMpguGEWSivDs55QX6YHJhRY5iEb1uvS1Desg1HhQjAJl8PVLRJSk-xJPu";
    ...
    private void getPayment() {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(amount)), "MYR", "Donation Fees",
